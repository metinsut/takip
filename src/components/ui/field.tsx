  ...
  return (
    <div
      ...
      className={cn(
        ...
        "flex-col gap-3 data-[slot=checkbox-group]:gap-3 *:data-[slot=field-group]:gap-3",
        className,
      )}
      {...props}
    />
...
function Field({
  ...
  return (
    // biome-ignore lint/a11y/useSemanticElements: we need to use a div to wrap the fieldset
    <div
      role="group"
      data-slot="field"
