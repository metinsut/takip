      ...
      >
        <TooltipPrimitive.Popup
          ...
          className={cn(
            ...
            "has-data-[slot=kbd]:pe-1.5 data-[side=bottom]:slide-in-from-top-2",
        ...
        >
          ...
          <TooltipPrimitive.Arrow
            className={cn(
              ...
              "data-[side=inline-end]:top-1/2! data-[side=inline-end]:-inset-s-1",
              "data-[side=inline-end]:-translate-y-1/2 data-[side=inline-start]:top-1/2!",
              "data-[side=inline-start]:-inset-e-1 data-[side=inline-start]:-translate-y-1/2",
